...
AS
BEGIN
    INSERT INTO AccountStudents values (StudentID, Passwd)
...
AS
BEGIN
    INSERT INTO AccountTeachers Values (TeacherID, Passwd)
...
INSERT INTO Student 
VALUES 
('S001', N'Ng?c', N'Tr?n', 'ngoc.tran01@email.com.vn', '9876543210', '2000-03-15'),
('S002', N'Dung', N'Nguy?n', 'dung.nguyen02@email.com.vn', '9876543211', 300.00, '2002-04-20'),
('S003', N'H?ng', N'Lê', 'huong.le03@email.com.vn', '9876543212',  '1999-05-10'),
('S004', N'Phát', N'??ng', 'phat.dang04@email.com.vn', '9876543213', '2003-06-12'),
('S005', N'Th?o', N'Ph?m', 'thao.pham05@email.com.vn', '9876543214', '2001-07-18'),
('S006', N'Bình', N'Võ', 'binh.vo06@email.com.vn', '9876543215',  '1998-08-25'),
('S007', N'Lan', N'H?', 'lan.ho07@email.com.vn', '9876543216', '2002-09-19'),
('S008', N'Khang', N'Bùi', 'khang.bui08@email.com.vn', '9876543217', '2000-11-23'),
('S009', N'Mai', N'L??ng', 'mai.luong09@email.com.vn', '9876543218', '1997-01-14'),
('S010', N'Vi?t', N'Chu', 'viet.chu10@email.com.vn', '9876543219',  '1999-02-28'),
('S011', N'Thu', N'D??ng', 'thu.duong11@email.com.vn', '9876543220',  '2002-01-15'),
('S012', N'Khiêm', N'??', 'khiem.do12@email.com.vn', '9876543221',  '2001-05-09'),
('S013', N'Chi', N'Lý', 'chi.ly13@email.com.vn', '9876543222',  '2000-06-13'),
('S014', N'Nga', N'Ngô', 'nga.ngo14@email.com.vn', '9876543223', '2002-08-21'),
('S015', N'Hào', N'V??ng', 'hao.vuong15@email.com.vn', '9876543224', '1999-12-05'),
('S016', N'Trang', N'Cao', 'trang.cao16@email.com.vn', '9876543225', '2001-11-29'),
('S017', N'H?i', N'Mã', 'hai.ma17@email.com.vn', '9876543226', '2003-02-20'),
('S018', N'Tuy?t', N'?inh', 'tuyet.dinh18@email.com.vn', '9876543227', '2002-10-27'),
('S019', N'Duy', N'Phùng', 'duy.phung19@email.com.vn', '9876543228', '1998-09-11'),
('S020', N'Th?y', N'Hà', 'thuy.ha20@email.com.vn', '9876543229', '2000-03-23'),
('S021', N'Lâm', N'La', 'lam.la21@email.com.vn', '9876543230', '2001-04-04'),
('S022', N'Tâm', N'Kh??ng', 'tam.khuong22@email.com.vn', '9876543231', '1997-05-15'),
('S023', N'Phong', N'Phan', 'phong.phan23@email.com.vn', '9876543232', '2002-07-07'),
('S024', N'M?', N'?ào', 'my.dao24@email.com.vn', '9876543233',  '1999-08-16'),
('S025', N'Quang', N'H?a', 'quang.hua25@email.com.vn', '9876543234',  '2003-11-12'),
('S026', N'Nguyên', N'B?ch', 'nguyen.bach26@email.com.vn', '9876543235',  '2002-09-21'),
('S027', N'Y?n', N'Chung', 'yen.chung27@email.com.vn', '9876543236',  '2000-10-30'),
('S028', N'S?n', N'L?c', 'son.luc28@email.com.vn', '9876543237',  '1998-12-10'),
('S029', N'Thanh', N'Yên', 'thanh.yen29@email.com.vn', '9876543238', '1999-01-20'),
('S030', N'Nhi', N'Nguy?n', 'nhi.nguyen30@email.com.vn', '9876543239',  '2001-02-22')

SELECT * FROM Student
INSERT INTO Teacher 
VALUES 
('T001', N'H?i', N'Nguy?n', 'hai.nguyen01@email.com.vn', '0123456789', '1985-03-15'),
('T002', N'Lan', N'Ph?m', 'lan.pham02@email.com.vn', '0123456790', '1982-04-20'),
('T003', N'Nam', N'Lê', 'nam.le03@email.com.vn', '0123456791', '1986-05-10'),
('T004', N'Ph??ng', N'??ng', 'phuong.dang04@email.com.vn', '0123456792', '1980-06-12'),
('T005', N'Tùng', N'Tr?n', 'tung.tran05@email.com.vn', '0123456793', '1984-07-18'),
('T006', N'H??ng', N'Võ', 'huong.vo06@email.com.vn', '0123456794', '1983-08-25'),
('T007', N'B?o', N'H?', 'bao.ho07@email.com.vn', '0123456795', '1981-09-19'),
('T008', N'Th?o', N'Bùi', 'thao.bui08@email.com.vn', '0123456796', '1982-11-23'),
('T009', N'S?n', N'L??ng', 'son.luong09@email.com.vn', '0123456797', '1987-01-14'),
('T010', N'Mai', N'Chu', 'mai.chu10@email.com.vn', '0123456798', '1983-02-28')

SELECT * FROM Teacher
INSERT INTO Classrooms
VALUES 
('C001', N'L?p trình C# c? b?n', 0, 'T001', 5000000),
('C002', N'Thi?t k? giao di?n web', 0, 'T002', 5500000),
('C003', N'L?p trình Java', 0, 'T003', 5300000),
('C004', N'Qu?n tr? c? s? d? li?u', 0, 'T004', 6000000),
('C005', N'L?p trình Python', 0, 'T005', 4800000),
('C006', N'Phân tích thi?t k? h? th?ng', 0, 'T006', 6500000),
('C007', N'L?p trình web PHP', 0, 'T007', 5100000),
('C008', N'L?p trình Android', 0, 'T008', 5800000),
('C009', N'Thi?t k? ?? h?a', 0, 'T009', 5200000),
('C010', N'K? thu?t l?p trình', 0, 'T010', 5400000)
